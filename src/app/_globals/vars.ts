...
export const API_KEY = 'yHyHGoT00hqK2tu3';
export const API_SECRET = 'AkQLPpCtjqem1pmA6UiNjbOjse3vIxzi';
...
export const PAST_MATCHES = ENABLE_CROSS_ORIGIN_URL + 'http://livescore-api.com/api-client/scores/history.json';
